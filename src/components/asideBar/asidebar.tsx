      ...
      <div className='asidebar__temp' >
        {AppCurrentWeather.weather != undefined
          ...
          <>
            ...
            <p className='asidebar__temp--pm'>{Math.round(AppCurrentWeather.main.temp)}℃ </p>
            <p className='asidebar__temp--pm'> Min temp {Math.round(AppCurrentWeather.main.temp_min)}℃ </p>
            <p className='asidebar__temp--pm'> Max temp {Math.round(AppCurrentWeather.main.temp_max)}℃ </p>
